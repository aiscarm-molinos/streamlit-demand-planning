...
más el visualizador de AWS SageMaker (AWS S3).
...
sidebar ni son alcanzables por URL. "AWS SageMaker" es
...
paginas_experimentos_sagemaker = [
    st.Page("pages/9_Experimentos_SageMaker.py", title="Explorador de Entrenamientos", icon="🧪"),
...
if st.session_state.get("datos_cargados", False):
    paginas = {
        ...
        "AWS SageMaker": paginas_experimentos_sagemaker,
    }
else:
    paginas = {
        "": [inicio],
